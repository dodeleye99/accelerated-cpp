...
### Extension:
3) **split** does further experimentation with iterators. On every line, it receives a sentence as user input, splits it into a vector of its words, then uses an iterator to output the words line by line.
### New Concepts:
