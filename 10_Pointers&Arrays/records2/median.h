...
/**
 * Calculates the median of the (assumed numerical typed T) values in a sequence defined by 
...
{
    // when defining mnemonic, use typename to specify vector<T>::size_type as the name of a type.
